...
<form action="" style="width: 96%;margin: 10px auto;">
    <table id="jqtable">
        ...
        <tr>
            <td colspan="9" id="kind" style="text-align: center;">库区安置登记表</td>
        </tr>
        <tr>
    ...
    <%--<table id="jqtable2" style="display: none;">--%>
        <%--<tbody>--%>
        <%--<tr>--%>
            <%--<td colspan="9" id="fid2"><p>库区安置登记表:<span></span></p></td>--%>
        <%--</tr>--%>
        <%--<tr>--%>
            <%--<td colspan="9">库区安置登记表</td>--%>
        <%--</tr>--%>
        <%--<tr>--%>
            <%--<td rowspan="2" class="bgc">户主信息</td>--%>
            <%--<td class="bgc">所属水库</td>--%>
        ...
        <%--<tr>--%>
            <%--<td class="bgc">开户人姓名</td>--%>
            <%--<td><input type="text" id="bank-user2"></td>--%>
            <%--<td class="bgc">开户行名称</td>--%>
            <%--<td colspan="2"></td>--%>
            <%--<td class="bgc">银行卡号</td>--%>
            <%--<td colspan="2"></td>--%>
    ...
    <ul id="btn-container">
        ...
        <%--<li><a href="#"  class="btn btn-info" data-type="xls">导出Excel</a></li>--%>
